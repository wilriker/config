...
herbstclient keybind $Mod-Return spawn st -f "Inconsolata\-g for Powerline:size=11:antialias=true"
herbstclient keybind $Mod-d spawn $HOME/.config/herbstluftwm/dmenu_run_hlwm -i -nb '#1e1e1e' -nf '#888888' -sb '#87afd7' -sf '#1e1e1e'
